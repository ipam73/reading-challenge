...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function () {
	    ...
	    render: function() {
	      return React.createElement("div", null, 
	        React.createElement("div", null, 
	          React.createElement("h2", null, this.props.parent.name.first, " ", this.props.parent.name.last)
	        ), 
	        React.createElement(NewStudent, null), 
	        React.createElement("div", null, 
	          React.createElement("ul", {className: "list-unstyled"}, 
	          this.props.students.map(function(student){
	            return React.createElement(Student, {name: student.name, key: student.id});
	          })
	          )
	        )
	      );
	  ...
	  var Student = React.createClass({displayName: "Student",
	    render: function() {
	      return React.createElement("div", null, React.createElement("li", null, this.props.name));
	    }
	  })

	  var NewStudent = React.createClass({displayName: "NewStudent",
	    render: function() {
	      return React.createElement("div", null, 
	        React.createElement("a", {href: "/addstudent"}, "Add a student")
	      )
	    }
	  })
